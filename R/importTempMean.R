...
#' La raster a une resolution de 1km.
#'
...
#' @export
#'
#' @import MODISTools raster dplyr sf
#'
importTempMean <- function(zoneEtude, firstDate = stop("Choisir une date de depart"), endDate = format(Sys.time(), "%Y-%m-%d"), bufferTemp = 4000){
